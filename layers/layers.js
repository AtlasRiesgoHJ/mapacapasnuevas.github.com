...
var format_MAPASDERIESGOZonanoaptaparahabitar_68 = new ol.format.GeoJSON();
var features_MAPASDERIESGOZonanoaptaparahabitar_68 = format_MAPASDERIESGOZonanoaptaparahabitar_68.readFeatures(json_MAPASDERIESGOZonanoaptaparahabitar_68, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MAPASDERIESGOZonanoaptaparahabitar_68 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MAPASDERIESGOZonanoaptaparahabitar_68.addFeatures(features_MAPASDERIESGOZonanoaptaparahabitar_68);
var lyr_MAPASDERIESGOZonanoaptaparahabitar_68 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_MAPASDERIESGOZonanoaptaparahabitar_68, 
                style: style_MAPASDERIESGOZonanoaptaparahabitar_68,
                interactive: true,
                title: '<img src="styles/legend/MAPASDERIESGOZonanoaptaparahabitar_68.png" /> MAPAS DE RIESGO  / Zona no apta para habitar'
            });
var format_HISTRICOS2020Huajuapansismo2020_69 = new ol.format.GeoJSON();
var features_HISTRICOS2020Huajuapansismo2020_69 = format_HISTRICOS2020Huajuapansismo2020_69.readFeatures(json_HISTRICOS2020Huajuapansismo2020_69, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HISTRICOS2020Huajuapansismo2020_69 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HISTRICOS2020Huajuapansismo2020_69.addFeatures(features_HISTRICOS2020Huajuapansismo2020_69);
var lyr_HISTRICOS2020Huajuapansismo2020_69 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_HISTRICOS2020Huajuapansismo2020_69, 
                style: style_HISTRICOS2020Huajuapansismo2020_69,
                interactive: true,
                title: '<img src="styles/legend/HISTRICOS2020Huajuapansismo2020_69.png" /> HISTÓRICOS 2020  / Huajuapan sismo 2020 '
            });
var format_HISTRICOSHundimientos_70 = new ol.format.GeoJSON();
var features_HISTRICOSHundimientos_70 = format_HISTRICOSHundimientos_70.readFeatures(json_HISTRICOSHundimientos_70, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HISTRICOSHundimientos_70 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HISTRICOSHundimientos_70.addFeatures(features_HISTRICOSHundimientos_70);
var lyr_HISTRICOSHundimientos_70 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_HISTRICOSHundimientos_70, 
                style: style_HISTRICOSHundimientos_70,
                interactive: true,
                title: '<img src="styles/legend/HISTRICOSHundimientos_70.png" /> * HISTÓRICOS  / Hundimientos '
            });
var format_HISTRICOSHuajuapansismo20172019_71 = new ol.format.GeoJSON();
var features_HISTRICOSHuajuapansismo20172019_71 = format_HISTRICOSHuajuapansismo20172019_71.readFeatures(json_HISTRICOSHuajuapansismo20172019_71, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HISTRICOSHuajuapansismo20172019_71 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HISTRICOSHuajuapansismo20172019_71.addFeatures(features_HISTRICOSHuajuapansismo20172019_71);
var lyr_HISTRICOSHuajuapansismo20172019_71 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_HISTRICOSHuajuapansismo20172019_71, 
                style: style_HISTRICOSHuajuapansismo20172019_71,
                interactive: true,
                title: '<img src="styles/legend/HISTRICOSHuajuapansismo20172019_71.png" /> HISTÓRICOS  / Huajuapan sismo 2017 - 2019'
            });
var format_HDRICAHidrolneas_72 = new ol.format.GeoJSON();
var features_HDRICAHidrolneas_72 = format_HDRICAHidrolneas_72.readFeatures(json_HDRICAHidrolneas_72, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HDRICAHidrolneas_72 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HDRICAHidrolneas_72.addFeatures(features_HDRICAHidrolneas_72);
var lyr_HDRICAHidrolneas_72 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_HDRICAHidrolneas_72, 
                style: style_HDRICAHidrolneas_72,
                interactive: true,
                title: '<img src="styles/legend/HDRICAHidrolneas_72.png" /> HÍDRICA  / Hidrolíneas'
            });
var format_INFORMACINCOMPLEMENTARIACalles_73 = new ol.format.GeoJSON();
var features_INFORMACINCOMPLEMENTARIACalles_73 = format_INFORMACINCOMPLEMENTARIACalles_73.readFeatures(json_INFORMACINCOMPLEMENTARIACalles_73, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_INFORMACINCOMPLEMENTARIACalles_73 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_INFORMACINCOMPLEMENTARIACalles_73.addFeatures(features_INFORMACINCOMPLEMENTARIACalles_73);
var lyr_INFORMACINCOMPLEMENTARIACalles_73 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_INFORMACINCOMPLEMENTARIACalles_73, 
                style: style_INFORMACINCOMPLEMENTARIACalles_73,
                interactive: true,
                title: '<img src="styles/legend/INFORMACINCOMPLEMENTARIACalles_73.png" /> INFORMACIÓN COMPLEMENTARIA  / Calles'
            });
var format_INFORMACINCOMPLEMENTARIAFrentedemanzana_74 = new ol.format.GeoJSON();
var features_INFORMACINCOMPLEMENTARIAFrentedemanzana_74 = format_INFORMACINCOMPLEMENTARIAFrentedemanzana_74.readFeatures(json_INFORMACINCOMPLEMENTARIAFrentedemanzana_74, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_INFORMACINCOMPLEMENTARIAFrentedemanzana_74 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_INFORMACINCOMPLEMENTARIAFrentedemanzana_74.addFeatures(features_INFORMACINCOMPLEMENTARIAFrentedemanzana_74);
var lyr_INFORMACINCOMPLEMENTARIAFrentedemanzana_74 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_INFORMACINCOMPLEMENTARIAFrentedemanzana_74, 
                style: style_INFORMACINCOMPLEMENTARIAFrentedemanzana_74,
                interactive: true,
                title: '<img src="styles/legend/INFORMACINCOMPLEMENTARIAFrentedemanzana_74.png" /> INFORMACIÓN COMPLEMENTARIA  / Frente de manzana'
            });
var format_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75 = new ol.format.GeoJSON();
var features_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75 = format_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75.readFeatures(json_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75.addFeatures(features_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75);
var lyr_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75, 
                style: style_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75,
                interactive: true,
                title: '<img src="styles/legend/INFORMACINCOMPLEMENTARIADivisinterritorial2020_75.png" /> INFORMACIÓN COMPLEMENTARIA  / División territorial 2020'
            });
var group_DATOSBSICOS = new ol.layer.Group({
                                layers: [lyr_HDRICAHidrolneas_72,lyr_INFORMACINCOMPLEMENTARIACalles_73,lyr_INFORMACINCOMPLEMENTARIAFrentedemanzana_74,lyr_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75,],
                                title: "DATOS BÁSICOS"});
var group_GEOLGICOS = new ol.layer.Group({
                                layers: [lyr_PELIGROSDeslizamientoladerasCONABIO_66,lyr_SUSCEPTIBILIDADErosinzonahjo_67,lyr_MAPASDERIESGOZonanoaptaparahabitar_68,lyr_HISTRICOS2020Huajuapansismo2020_69,lyr_HISTRICOSHundimientos_70,lyr_HISTRICOSHuajuapansismo20172019_71,],
                                title: "GEOLÓGICOS"});
...
lyr_MAPASDERIESGOZonanoaptaparahabitar_68.set('fieldAliases', {'fid': 'fid', });
lyr_HISTRICOS2020Huajuapansismo2020_69.set('fieldAliases', {'NOM_LIMPIE': 'NOM_LIMPIE', 'FECHA': 'FECHA', 'NOM_NUM': 'NOM_NUM', 'CVE': 'CVE', 'NUM_LOGBG': 'NUM_LOGBG', 'LONGITUD': 'LONGITUD', 'LATITUD': 'LATITUD', 'DAN_SEDAT': 'DAN_SEDAT', 'SISMOS': 'SISMOS', 'DIRECCION': 'DIRECCION', 'REFERE': 'REFERE', 'OBSERVACNS': 'OBSERVACNS', 'CAMPO_12': 'CAMPO_12', 'OID': 'OID', });
lyr_HISTRICOSHundimientos_70.set('fieldAliases', {'FECHA': 'FECHA', 'HORA_INI': 'HORA_INI', 'HORA_FIN': 'HORA_FIN', 'UNIDADES': 'UNIDADES', 'REPORTA': 'REPORTA', 'LUGAR': 'LUGAR', 'OBSRVCIONS': 'OBSRVCIONS', 'REPORTE': 'REPORTE', 'FUENTE': 'FUENTE', });
lyr_HISTRICOSHuajuapansismo20172019_71.set('fieldAliases', {'fid': 'fid', });
lyr_HDRICAHidrolneas_72.set('fieldAliases', {'fid': 'fid', });
lyr_INFORMACINCOMPLEMENTARIACalles_73.set('fieldAliases', {'fid': 'fid', });
lyr_INFORMACINCOMPLEMENTARIAFrentedemanzana_74.set('fieldAliases', {'fid': 'fid', });
lyr_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75.set('fieldAliases', {'fid': 'fid', });
...
lyr_HISTORICOS2021Incendiovehicular_21.set('fieldImages', {'TIPO': 'TextEdit', 'FECHA': 'TextEdit', 'DIRECTION': 'TextEdit', 'HORA_INI': 'TextEdit', 'HORA_TERM': 'TextEdit', 'REPORTA': 'TextEdit', 'UNIDADS': 'TextEdit', 'OBSERVACNS': 'TextEdit', 'LESIONADS': 'TextEdit', 'FALLECIDS': 'TextEdit', 'FUENTE': 'TextEdit', 'IMAGEN': 'TextEdit', });
lyr_HISTRICOS2021Eventoelctrico_22.set('fieldImages', {'fid': 'TextEdit', });
lyr_HISTRICOS2021Fugadegas_23.set('fieldImages', {'FENOMENO': 'TextEdit', 'TIPO': 'TextEdit', 'LUGAR': 'TextEdit', 'FECHA': 'TextEdit', 'HORA': 'TextEdit', 'UNIDADS': 'TextEdit', 'CULMINA': 'TextEdit', 'REPORTA': 'TextEdit', 'OBSERVACNS': 'TextEdit', 'LESIONADO': 'TextEdit', 'FALLECIDOS': 'TextEdit', 'FUENTE': 'TextEdit', });
lyr_HISTRICOS2021Incendiocasahabitacin_24.set('fieldImages', {'TIPO': 'TextEdit', 'FECHA': 'TextEdit', 'HORA_INC': 'TextEdit', 'HORA_SALI': 'TextEdit', 'LUGAR': 'TextEdit', 'REPORTA': 'TextEdit', 'UNIDADS': 'TextEdit', 'OBSERVCNS': 'TextEdit', 'FALLECIDOS': 'TextEdit', 'LESIONADOS': 'TextEdit', 'FUENTE': 'TextEdit', });
lyr_HISTRICOS2021Derramedecombustible2021_25.set('fieldImages', {'FECHA': 'TextEdit', 'HORA_INI': 'TextEdit', 'HORA_FIN': 'TextEdit', 'MANDO': 'TextEdit', 'UNIDADES': 'TextEdit', 'ELEMNTOS': 'TextEdit', 'REPORTA': 'TextEdit', 'DIRECCION': 'TextEdit', 'OBSRVCIONS': 'TextEdit', 'AUTORIDS': 'TextEdit', 'FUENTE': 'TextEdit', 'Tipo': 'TextEdit', ' imagen': 'TextEdit', });
lyr_HISTRICOS2021Eventoelctrico_26.set('fieldImages', {'TIPO': 'TextEdit', 'FECHA': 'TextEdit', 'LUGAR': 'TextEdit', 'HORA_SAL': 'TextEdit', 'HORA_INIC': 'TextEdit', 'HORA_TERM': 'TextEdit', 'REPORTA': 'TextEdit', 'UNIDADS': 'TextEdit', 'OBSERVACNS': 'TextEdit', 'LESIONADOS': 'TextEdit', 'FALLECIDOS': 'TextEdit', 'FUENTE': 'TextEdit', 'PASA_REP': 'TextEdit', });
lyr_HISTRICOS2021Incendios2021_27.set('fieldImages', {'FECHA': 'TextEdit', 'HORA_INI': 'TextEdit', 'HORA_FIN': 'TextEdit', 'REPORTA': 'TextEdit', 'UNIDADS': 'TextEdit', 'LUGAR': 'TextEdit', 'AUT_AUXI': 'TextEdit', 'OBSRVCIONS': 'TextEdit', 'FUENTE': 'TextEdit', 'SUBCATEGOR': 'TextEdit', 'Area': 'TextEdit', 'IMAGEN': 'TextEdit', 'IMAGEN2': 'TextEdit', 'CATEGORIA': 'TextEdit', });
lyr_HISTRICOS2021Incendiodecomercios2021_28.set('fieldImages', {'TIPO': 'TextEdit', 'FECHA': 'TextEdit', 'HORA_INC': 'TextEdit', 'HORA_SALI': 'TextEdit', 'LUGAR': 'TextEdit', 'REPORTA': 'TextEdit', 'UNIDADS': 'TextEdit', 'OBSERVCNS': 'TextEdit', 'FALLECIDOS': 'TextEdit', 'LESIONADOS': 'TextEdit', 'FUENTE': 'TextEdit', });
lyr_HISTRICOS2020Eventoelctrico_29.set('fieldImages', {'fid': 'TextEdit', });
lyr_HISTRICOS2020Fugadeamoniaco_30.set('fieldImages', {'fecha': 'TextEdit', 'hora_ini': 'TextEdit', 'hora_fin': 'TextEdit', 'evento': 'TextEdit', 'unidades': 'TextEdit', 'otros': 'TextEdit', 'obsrvcions': 'TextEdit', 'fuente': 'TextEdit', });
lyr_HISTRICOS2020Fugadegas2020_31.set('fieldImages', {'FENOMENO': 'TextEdit', 'TIPO': 'TextEdit', 'LUGAR': 'TextEdit', 'FECHA': 'TextEdit', 'HORA': 'TextEdit', 'UNIDADS': 'TextEdit', 'CULMINA': 'TextEdit', 'OBSERVACNS': 'TextEdit', 'LESIONADO': 'TextEdit', 'FALLECIDOS': 'TextEdit', 'FUENTE': 'TextEdit', });
lyr_HISTRICOS2020Incendio_32.set('fieldImages', {'TIPO': 'TextEdit', 'FECHA': 'TextEdit', 'HORA_SAL': 'TextEdit', 'HORA_ARRIB': 'TextEdit', 'HORA_TERM': 'TextEdit', 'RETORN_BAS': 'TextEdit', 'LLEG_BASE': 'TextEdit', 'LUGAR': 'TextEdit', 'GUARDIA': 'TextEdit', 'REPORTA': 'TextEdit', 'UNIDADS': 'TextEdit', 'MANDO': 'TextEdit', 'PERSONL': 'TextEdit', 'OID': 'Range', 'OBSERVACNS': 'TextEdit', 'FUENTE': 'TextEdit', });
...
lyr_MAPASDERIESGOZonanoaptaparahabitar_68.set('fieldImages', {'fid': 'TextEdit', });
lyr_HISTRICOS2020Huajuapansismo2020_69.set('fieldImages', {'NOM_LIMPIE': 'TextEdit', 'FECHA': 'TextEdit', 'NOM_NUM': 'TextEdit', 'CVE': 'TextEdit', 'NUM_LOGBG': 'TextEdit', 'LONGITUD': 'TextEdit', 'LATITUD': 'TextEdit', 'DAN_SEDAT': 'TextEdit', 'SISMOS': 'TextEdit', 'DIRECCION': 'TextEdit', 'REFERE': 'TextEdit', 'OBSERVACNS': 'TextEdit', 'CAMPO_12': 'TextEdit', 'OID': 'Range', });
lyr_HISTRICOSHundimientos_70.set('fieldImages', {'FECHA': 'TextEdit', 'HORA_INI': 'TextEdit', 'HORA_FIN': 'TextEdit', 'UNIDADES': 'TextEdit', 'REPORTA': 'TextEdit', 'LUGAR': 'TextEdit', 'OBSRVCIONS': 'TextEdit', 'REPORTE': 'TextEdit', 'FUENTE': 'TextEdit', });
lyr_HISTRICOSHuajuapansismo20172019_71.set('fieldImages', {'fid': 'TextEdit', });
lyr_HDRICAHidrolneas_72.set('fieldImages', {'fid': 'TextEdit', });
lyr_INFORMACINCOMPLEMENTARIACalles_73.set('fieldImages', {'fid': 'TextEdit', });
lyr_INFORMACINCOMPLEMENTARIAFrentedemanzana_74.set('fieldImages', {'fid': 'TextEdit', });
lyr_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75.set('fieldImages', {'fid': 'TextEdit', });
...
lyr_MAPASDERIESGOZonanoaptaparahabitar_68.set('fieldLabels', {});
lyr_HISTRICOS2020Huajuapansismo2020_69.set('fieldLabels', {});
lyr_HISTRICOSHundimientos_70.set('fieldLabels', {});
lyr_HISTRICOSHuajuapansismo20172019_71.set('fieldLabels', {});
lyr_HDRICAHidrolneas_72.set('fieldLabels', {});
lyr_INFORMACINCOMPLEMENTARIACalles_73.set('fieldLabels', {});
lyr_INFORMACINCOMPLEMENTARIAFrentedemanzana_74.set('fieldLabels', {});
lyr_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75.set('fieldLabels', {});
lyr_INFORMACINCOMPLEMENTARIADivisinterritorial2020_75.on('precompose', function(evt) {
